...
export default function HomeIntro() {
  ...
  return (
    <div id='home-intro' className='intro-section'>
      <h1>Oléron Villa</h1>
      <img
      ...
      { language === "en" &&
        <div className='responsive-text'>
          <h2>Welcome to Oléron Villa, a luxury, well equipped holiday home on Île d'Oléron - just a few minutes' walk through the woods from glorious family & surf beaches.</h2>
      ...
      { language === "fr" &&
      <div className='responsive-text'>
          <h2>Bienvenue sur Oléron Villa, une maison de vacances haut de gamme et très bien équipée sur la belle île d'Oléron réputée pour sa côte sauvage et ses plages de sable fin à quelques minutes de marche à travers la forêt.</h2>
