...
export default function FacilitiesCell({action}) {
  ...
  const french = (<>
    ...
    <p>Pour lextérieur, en plus de 2 salons de jardin et d'un barbecue, des bains de soleil vous permettront de vous relaxer au soleil… attention à bien vous protéger!</p>
  </>);
